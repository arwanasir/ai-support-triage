...
ALTER TABLE "agents_action" ADD CONSTRAINT "agents_action_run_id_ai_runs_id_fk" FOREIGN KEY ("run_id") REFERENCES "public"."ai_runs"("id") ON DELETE cascade ON UPDATE no action;
*/